...
spa.chat = (function(){
    ...
    //  そして、要素、イベント、ハンドラを初期化し、ユーザにチャットルームインターフェースを
    //  提供する
    ...
    handleResize = function(){
        ...
        if( stateMap.position_type === 'opened'){
            jqueryMap.$slider.css({
                height: stateMap.slider_opened_em
            })
        }
        return true;
    };
